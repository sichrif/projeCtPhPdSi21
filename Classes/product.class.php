...
public function add_new($name,$description,$price,$file,$categorie)
{
    try{
    
    $repp='INSERT INTO products(name, description, price , file,categorie) 
    VALUES ( :param_name,:param_description,:param_price,:param_file,:categorie);';
    ...
    $rep->bindParam(':categorie',$categorie);
    $rep->execute();
 return $rep;
}catch (Exception $e) {
    echo  $e->getMessage();
