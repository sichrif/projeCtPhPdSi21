                            ...
                            <div class="header-top-right">
                                ...
                                <div class="language-menu">
                                    <a href="#" class="current-lang">Setting Menu <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                        <ul>
                                        <li><a href="modifier.php?cid=<?php $data['cid'] ?>"> <i class="fa fa-angle-right" aria-hidden="true"></i>Account Setting</a></li>                                            <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Log out</a></li>
                                        </ul>
                                </div>
                            </div>
                        </div>
